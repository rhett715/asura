...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRole> implements SysRoleService {
    ...
    public TableDataInfo<SysRole> selectPageRoleList(SysRole role) {
        return PageUtils.buildDataInfo(roleMapper.selectPageRoleList(PageUtils.buildPage(), role));
    }
    ...
    public String checkRoleNameUnique(SysRole role) {
        ...
        SysRole info = getOne(Wrappers.lambdaQuery(SysRole.class)
    ...
    public int updateRole(SysRole role) {
        ...
        // 删除角色与菜单关联
        roleMenuMapper.delete(Wrappers.lambdaQuery(SysRoleMenu.class).eq(SysRoleMenu::getRoleId, role.getRoleId()));
        return insertRoleMenu(role);
    }
    ...
    public int authDataScope(SysRole role) {
        ...
        roleMapper.updateById(role);
        // 删除角色与部门关联
        roleDeptMapper.delete(Wrappers.lambdaQuery(SysRoleDept.class).eq(SysRoleDept::getRoleId, role.getRoleId()));
        // 新增角色和部门信息（数据权限）
    ...
    public int insertRoleMenu(SysRole role) {
        ...
        if (roleMenuList.size() > 0) {
            rows = roleMenuMapper.insertBatchRoleMenu(roleMenuList);
        }
        return rows;
    }
    ...
    public int insertRoleDept(SysRole role) {
        ...
        if (roleDeptList.size() > 0) {
            rows = roleDeptMapper.insertBatchRoleDept(roleDeptList);
        }
        return rows;
    }
    ...
    public int deleteRoleById(Long roleId) {
        // 删除角色与菜单关联
        roleMenuMapper.delete(Wrappers.lambdaQuery(SysRoleMenu.class).eq(SysRoleMenu::getRoleId, roleId));
        // 删除角色与部门关联
        roleDeptMapper.delete(Wrappers.lambdaQuery(SysRoleDept.class).eq(SysRoleDept::getRoleId, roleId));
    ...
    public int deleteRoleByIds(Long[] roleIds) {
        ...
        // 删除角色与菜单关联
        roleMenuMapper.delete(Wrappers.lambdaQuery(SysRoleMenu.class).in(SysRoleMenu::getRoleId, ids));
        // 删除角色与部门关联
        roleDeptMapper.delete(Wrappers.lambdaQuery(SysRoleDept.class).in(SysRoleDept::getRoleId, ids));
    ...
    public int insertAuthUsers(Long roleId, Long[] userIds) {
        ...
        if (userRoleList.size() > 0) {
            rows = userRoleMapper.insertBatchUserRole(userRoleList);
        }
        return rows;
    }
}
